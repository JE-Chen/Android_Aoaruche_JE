...
public class JExFirebase {
   ...
   String money_skill_lv,String critical_lv ,String healing_lv,String dodge_lv,String miracle_of_live_lv,String great_mage_lv,String exercise_lv) {
    ...
    // very very very very very very very very very very very very very... important function
    public void JExFirebase_set_JExFight(long Magic_Power,long hp_lv,long what_region_save,long coin,long UP_Magic_Power,long UP_Hp_Lv,long Skill_Points,
                    long data1, long data2, long data3, long data4, long data5, long data6) {

        JExFight_Gesture.Magic_Power = Magic_Power;
        JExFight_Gesture.hp_lv = hp_lv;
        JExFight_Gesture.what_region_save = what_region_save;
        JExFight_Gesture.coin = coin;
        JExFight_Gesture.need_cash_to_up_magic_power = UP_Magic_Power;
        JExFight_Gesture.need_cash_to_up_hp_lv = UP_Hp_Lv;
        JExFight_Gesture.skill_points = Skill_Points;
        JExFight_Gesture.data1 = data1;
        JExFight_Gesture.data2 = data2;
        JExFight_Gesture.data3 = data3;
        JExFight_Gesture.data4 = data4;
        JExFight_Gesture.data5 = data5;
        JExFight_Gesture.data6 = data6;
    }
 public void JE_set_JExSkill(long money_skill_lv,long critical_lv, long healing_lv,long dodge_lv,long miracle_of_live_lv,long great_mage_lv,long exercise_lv){

     JExSkill.money_skill_lv=money_skill_lv;
     JExSkill.critical_lv=critical_lv;
     JExSkill.healing_lv=healing_lv;
     JExSkill.dodge_lv=dodge_lv;
     JExSkill.miracle_of_live_lv=miracle_of_live_lv;
     JExSkill.great_mage_lv=great_mage_lv;
     JExSkill.exercise_lv=exercise_lv;
 }
}